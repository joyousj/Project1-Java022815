...
public class P3 {
	...
	public static void main(String[] args)  {
		...
		public static int[] countDigits(ArrayList<Integer> number) {
			int[] countTimes = new int[10];
			for(int i = 0; i < number.size(); i++){
			int num = number.get(i);
			countTimes[firstDigit(num)]++;
		}
		return countTimes;
	}
